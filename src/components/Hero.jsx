...
const Hero = () => {
  ...
  return (
    <div className=" min-h-screen w-full  flex justify-center items-center">
      <div className="lg:w-4/5 w-5/6 flex flex-col-reverse lg:flex-row justify-center gap-32 items-center">
        <div className="flex flex-col gap-9 justify-center items-center max-w-[600px]">
          ...
          <div className="w-full relative">
            <div
              ...
              className="bg-neutral w-full text-neutral-content font-manrope text-2xl py-5 px-5"
            >
              <div className="rounded-lg flex justify-between">
                <p className="text-left leading-8 left-0 px-5 font-semibold">
                  {titleSelected}
                </p>
                <IoMdArrowDropdown className="size-9" />
              </div>
            </div>
            {openTitle && (
              <div className="bg-neutral w-full text-neutral-content top-0 rounded-lg">
                {titles?.map((title) => (
                  <li
